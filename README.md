...
| プロジェクト | 概要 | 主な技術 |
|---|---|---|
| [helpdesk-hub](https://github.com/izumacha/helpdesk-hub) | 社内ヘルプデスク向けチケット管理システム。起票から対応・SLA 期限監視・エスカレーション・ダッシュボード分析・FAQ 化までを一元管理し、対応漏れと属人化を防止。 | Next.js 16 / React 19 / TypeScript / Prisma 7 / PostgreSQL / Auth.js / Tailwind CSS v4 |
| [incident-insight](https://github.com/izumacha/incident-insight) | 医療現場のインシデント管理ツール。報告から 5 Whys による根本原因分析・再発防止策・効果評価まで PDCA を一気通貫で管理し、再発を自動検知。 | C# / ASP.NET Core 8 MVC / EF Core 9 / SQLite / Bootstrap 5 / Chart.js |
